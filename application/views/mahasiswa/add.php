            ...
            ?>
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="bidang_keahlian" class="form-control" placeholder="Masukkan Bidang Keahlian">
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="periode_angkatan" class="form-control" placeholder="Periode Angkatan">
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="durasi_beasiswa" class="form-control" placeholder="Durasi Beasiswa">
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="lama_studi" class="form-control" placeholder="Lama Studi">
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="status_perkuliahan" class="form-control" placeholder="Status Perkuliahan">
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="status_beasiswa" class="form-control" placeholder="Status Beasiswa">
                      </div>
                  </div>
